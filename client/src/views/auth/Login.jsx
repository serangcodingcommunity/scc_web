        ...
        <>
            <div className="mt-20 sm:mx-auto sm:w-full sm:max-w-sm rounded-lg p-5 shadow-xl border-2 border-slate-50 relative bg-white">
                ...
                <div className="flex justify-center space-x-4 mt-2">
                    <button onClick={() => loginGoogleUrl && (window.location.href = loginGoogleUrl)} className="bg-white text-black border border-black rounded-lg flex items-center text-xs p-1 hover:scale-110">
                        <FaGoogle className="h-3 w-3 mr-2" />
                        Google
                    </button>
                    <button onClick={() => loginGithubUrl && (window.location.href = loginGithubUrl)} className="bg-white text-black border border-black rounded-lg flex items-center text-xs p-1 hover:scale-110">
