...
function CommentSection() {
    return (
        <section className="bg-bgPrimary dark:bg-gray-900 py-8 lg:py-16 antialiased">
            <div className="max-w-2xl mx-auto px-4">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-lg lg:text-2xl font-bold text-primary underline dark:text-white">Komentar</h2>
                </div>
                <form className="mb-6">
